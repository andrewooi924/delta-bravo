...
ALTER TABLE customer
    ADD CONSTRAINT chkcustlevel CHECK ( cust_level IN ( 'B', 'G', 'S' ) );
...
ALTER TABLE product
    ADD CONSTRAINT category_product FOREIGN KEY ( pcat_id )
