...
db.town.insertMany([{"_id":1,"name":"Byron Bay NSW","location":{"latitude":-28.6474,"longitude":153.602},"avg_temperature":{"summer":23.5,"winter":16.9},"no_of_resorts":1,"resorts":[{"id":1,"name":"Byron Bay Exclusive Resort","address":"1 Karma Road","phone":"0212429423","year_built":2012,"company_name":"Byron Holiday"}]},
...
db.town.updateOne({"_id":1}, {"$push":{"resorts":{"id":5,"name":"Byron Bay Super Resort","address":"675 Lennon Street","phone":"0224811234","year_built":2016,"company_name":"Byron Holiday"}}});
...
db.town.updateOne({"$and": [{"location.latitude": {"$eq":-20.7256}, "location.longitude": {"$eq":139.4927}}]}, {"$push": {"resorts": {"id": 10, "name": "Amazing Resort", "address": "77 Mount Isa Road", "phone": "0189709834", "year_built": 2020, "company_name": "Australia Experience"}}});
